    ...
    <div class="bg-tertiary-900">
        ...
        <div class="relative mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 gap-x-16 lg:px-8 lg:pt-16">
            <section
                ...
                class="bg-tertiary-800 py-12 md:px-10 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:w-full lg:max-w-lg lg:gb-transparent lg:px-0 lg:pb-24 lg:pt-0">
            ...
            <section
                ...
                class="py-16 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:w-full lg:mx-full lg:max-w-lg lg:pb-24 lg:pt-0">


                <form>
                    <div class="mx-auto max-w-xl px-4 lg:max-w-none lg:px-0">
                        <div>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-1">
                                    <x-text-input type="email" id="email-address" name="email" autocomplete="email" placeholder="Digite seu e-mail"/>
                                </div>
                            </div>
                        </div>
